...
<body>
            ...
            <div class="container_doc">
                ...
                <div class="form_doct">
                    <div class="doc_form">
                        ...
                        <div class="titulo">Agrega un Tratamiento</div>
                        <!-- Formulario para agregar doctores -->
                        <form id="trataForm" method="post" class="doctorForm">


                            <div class="input_group">
                                <label for="nombretrata" class="label">Nombre:</label>
                                <input type="text" id="nombretrata" name="nombretrata" autocomplete="off" class="input">

                            </div>

                            <div class="input_group">
                                <label for="preciotrata" class="label">Precio:</label>
                                <input type="text" id="preciotrata" name="preciotrata" autocomplete="off" class="input">

                            </div>


                            <div>
                                <button type="submit" onclick="mostrarAlerta()">Agregar Tratamiento</button>
                            </div>
                ...
                <div class="result_doct">
                    ...
                    <div class="buscador_form">
                        <h3 class="titulo_bus">Tratamientos</h3>
                        <button onclick="buscarTratamientos()">Buscar todos los Tratamientos</button>
                    </div>

                    <div id="resultados_doc" class="resultados_doc"></div>
    ...
    <script src="buscar_trat.js"></script>
</body>
